...
### 2. Note the outputs after the infrastructure created - private ip addresses of slaves - they are also automatically saved to "inventory" file similar to this: <br>
<br>
